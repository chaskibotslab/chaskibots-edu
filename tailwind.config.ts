  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neon-purple': '0 0 10px rgba(16,185,129,0.4), 0 0 30px rgba(16,185,129,0.2)',
        'neon-green': '0 0 10px rgba(18,184,134,0.4), 0 0 30px rgba(18,184,134,0.2)',
        'brand-purple': '0 4px 20px rgba(16,185,129,0.25)',
        'glow': '0 4px 20px rgba(16,185,129,0.15)',
        'glow-lg': '0 8px 40px rgba(16,185,129,0.2)',
