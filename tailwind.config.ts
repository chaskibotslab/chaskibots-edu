  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'brand-purple': '0 4px 20px rgba(229,115,97,0.3)',
        'glow': '0 4px 20px rgba(229,115,97,0.2)',
        'glow-lg': '0 8px 40px rgba(229,115,97,0.25)',
        'gold': '0 4px 20px rgba(245,158,11,0.3)',
        'hack-green': '0 0 12px rgba(34,197,94,0.4), 0 0 40px rgba(34,197,94,0.2)',
        'rose': '0 4px 20px rgba(229,115,97,0.3)',
      },
    },
  },
  plugins: [],
