...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'neon-cyan': '0 0 10px rgba(34,184,207,0.4), 0 0 30px rgba(34,184,207,0.2)',
        'neon-purple': '0 0 10px rgba(58,79,216,0.4), 0 0 30px rgba(58,79,216,0.2)',
        'neon-green': '0 0 10px rgba(18,184,134,0.4), 0 0 30px rgba(18,184,134,0.2)',
        'brand-purple': '0 4px 20px rgba(58,79,216,0.25)',
        'glow': '0 4px 20px rgba(58,79,216,0.15)',
        'glow-lg': '0 8px 40px rgba(58,79,216,0.2)',
        'gold': '0 4px 20px rgba(233,161,59,0.3)',
      },
    },
  },
  plugins: [],
