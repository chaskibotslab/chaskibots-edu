        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <span className="font-bold text-xl text-slate-900">ChaskiBots</span>
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://www.youtube.com/@chaskibots" target="_blank" rel="noopener noreferrer"
                 className="text-slate-500 hover:text-chaski-primary hover:scale-110 transition-all">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold mb-4 text-slate-900">Plataforma</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold mb-4 text-slate-900">Contacto</h4>
            <ul className="space-y-2 text-sm text-slate-600">
