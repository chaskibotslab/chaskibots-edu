        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link
              ...
              className="p-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-all active:scale-[0.98]"
            >
              <ArrowLeft className="w-5 h-5" />
            </Link>
            <div className="flex items-center gap-2">
              <div className={`w-10 h-10 bg-gradient-to-br ${isAdmin ? 'from-chaski-primary to-chaski-accent' : 'from-green-500 to-emerald-600'} rounded-lg flex items-center justify-center`}>
              ...
              <div>
                ...
                <p className="text-xs text-chaski-primary">Sistema de Calificaciones</p>
              </div>
            </div>
          </div>
