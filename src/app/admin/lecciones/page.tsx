  ...
  return (
    <div className="min-h-screen bg-dark-900">
      <header className="bg-dark-800 border-b border-dark-600 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Gestión de Lecciones</h1>
      ...
      <div className="p-6">
        ...
        {/* Lista de lecciones agrupadas por módulo */}
        {loading ? (
          ...
          <div className="bg-dark-800 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-dark-800 border-b border-dark-600 px-6 py-4 flex items-center justify-between">
              <h2 className="text-xl font-bold text-white">
                {isCreating ? 'Nueva Lección' : 'Editar Lección'}
              </h2>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-gray-400 mb-1">Nombre del Módulo *</label>
                  <input
                    type="text"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Pega el enlace de Google Drive o YouTube. El video se mostrará embebido.
                </p>
              </div>

              <div>
                <label className="block text-sm text-gray-400 mb-1">Contenido / Descripción</label>
                <textarea
                  rows={4}
              ...
              <div className="flex items-center gap-2">
                ...
                <label htmlFor="locked" className="text-gray-300">
                  Lección bloqueada (requiere completar anteriores)
                </label>
              </div>
            </div>
