      ...
      <main className="flex-1 py-6 px-4">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="text-center py-6">
            <div className="w-16 h-16 bg-brand-violet/10 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-brand-violet/30">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="bg-gray-50/80 backdrop-blur rounded-2xl p-5 border border-gray-200 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Detección</h3>
            ...
            <div className="bg-gray-50/80 backdrop-blur rounded-2xl p-5 border border-gray-200 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Clasificación</h3>
            ...
            <div className="bg-gray-50/80 backdrop-blur rounded-2xl p-5 border border-gray-200 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Voz</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-gray-50/80 backdrop-blur rounded-2xl p-5 border border-gray-200">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-brand-violet/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Lightbulb className="w-5 h-5 text-brand-violet" />
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">COCO-SSD</h3>
            ...
            <div className="bg-gray-50/80 backdrop-blur rounded-2xl p-5 border border-gray-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">MobileNet</h3>
