...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative bg-chaski-light flex items-start justify-center px-4 pt-12 pb-10">
      {/* Fondo suave, estático */}
      <div className="absolute inset-0 pointer-events-none" style={{
        backgroundImage: 'radial-gradient(ellipse at top, rgba(229,115,97,0.06) 0%, transparent 60%)',
      }} />
      ...
      <div className={`relative z-10 w-full max-w-md flex flex-col items-center ${mounted ? 'animate-login-enter' : 'opacity-0'}`}>
        ...
        <div className="relative mb-5">
          <div className="bg-white rounded-2xl shadow-md border border-border-soft p-3">
            <Image
              src="/logo.jpg"
              alt="Chaski Bots LAB"
              width={170}
        ...
        {/* Título */}
        <h1 className="text-chaski-dark text-2xl sm:text-3xl font-bold leading-tight text-center mb-2">
          El futuro se <span className="text-chaski-primary">construye</span> aquí
        </h1>
